...
class PageRankFASTest {
    ...
    class BasicFunctionalityTests {
        ...
        void testAcyclicGraph() {
            ...
            pageRankFAS = new PageRankFAS<>(graph);
        ...
        void testSimpleCycle() {
            ...
            PageRankFAS<String, DefaultEdge> verifier = new PageRankFAS<>(graph);
    ...
    class EdgeCaseTests {
        ...
        void testCustomPageRankIterations() {
            ...
            for (int iter : iterations) {
                Graph<String, DefaultEdge> testGraph = copyGraph(graph);
                PageRankFAS<String, DefaultEdge> customFAS = new PageRankFAS<>(testGraph, iter);
        ...
        void testThreadSafety() throws InterruptedException {
            ...
            for (int i = 0; i < NUM_THREADS; i++) {
                threads[i] = new Thread(() -> {
                    ...
                    PageRankFAS<String, DefaultEdge> threadFAS = new PageRankFAS<>(threadGraph);
    ...
    class CorrectnessTests {
        ...
        void testCompareWithSimpleHeuristic() {
            ...
            assertTrue(new PageRankFAS<>(testGraph1).computeFeedbackArcSet().isEmpty());

            Graph<String, DefaultEdge> testGraph2 = copyGraph(graph);
            greedyFas.forEach(testGraph2::removeEdge);
            assertTrue(new PageRankFAS<>(testGraph2).computeFeedbackArcSet().isEmpty());
        }
    }
