...
/**
 * Generates the RefactorFirst CSV report at
...
public class CsvReportTask extends DefaultTask {
    ...
    public void generate() {
        ...
        csvReport.execute(
                extension.isShowDetails(), projectName, projectVersion, outputDir.getAbsolutePath(), projectDirectory);
    }
