...
class JavaProjectParserTest {
    ...
    void parseSourceDirectoryEmptyTest() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> javaProjectParser.getClassReferences(""));
        Assertions.assertThrows(IllegalArgumentException.class, () -> javaProjectParser.getClassReferences(null));
    }
    ...
    void parseSourceDirectoryTest() throws IOException {
        ...
        Graph<String, DefaultWeightedEdge> classReferencesGraph =
                javaProjectParser.getClassReferences(srcDirectory.getAbsolutePath());
    ...
    void removeClassesNotInCodebase() throws IOException {
        ...
        javaProjectParser.removeClassesNotInCodebase(packagesInCodebase, classReferencesGraph);
